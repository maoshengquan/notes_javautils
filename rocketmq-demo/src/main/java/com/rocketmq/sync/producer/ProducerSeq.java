...
public class ProducerSeq {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DefaultMQProducer producer = new DefaultMQProducer("seq_message");
        // 设置NameServer的地址
        ...
        // 订单列表
        ProducerSeq producerSeq = new ProducerSeq();
        List<OrderStep> orderList = producerSeq.buildOrders();
        ...
        for (int i = 0; i < orderList.size(); i++) {
            ...
            Message msg = new Message("TopicTest-seq", tags[i % tags.length], "KEY" + i, body.getBytes());
     ...
     * 生成模拟订单数据
     */
    protected List<OrderStep> buildOrders() {
